...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { info: @operation.info, name: @operation.name, num_version: @operation.num_version }
    end
  ...
  test "should update operation" do
    put :update, id: @operation, operation: { info: @operation.info, name: @operation.name, num_version: @operation.num_version }
    assert_redirected_to operation_path(assigns(:operation))
  end
